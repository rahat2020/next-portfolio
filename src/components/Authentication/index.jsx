        ...
        <div className="">
            ...
            >
                <div className="flex items-center justify-center bg-gradient-to-b p-2">
                    <div className="w-full max-w-md rounded-2xl overflow-hidden transition-all duration-300 ease-in-out">
                        <div className="p-2">
                            <div className="flex bg-white bg-opacity-50 rounded-lg p-1 mb-8">
                                <button
                                    className={`flex-1 py-3 px-4 text-center text-sm sm:text-base font-semibold rounded-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${activeTab === 'signin'
                                ...
                                <button
                                    className={`flex-1 py-3 px-4 text-center text-sm sm:text-base font-semibold rounded-md transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${activeTab === 'signup'
                                        ? 'bg-indigo-600 text-white shadow-md'
                                        : 'text-gray-600 hover:bg-indigo-100'
                                        }`}
                    ...
                    transition-all duration-300 ease-in-out ${isLoading ? 'opacity-50 cursor-not-allowed' : ''
                                                }`}
                                        >
                                            {isLoading ? (
                                                <>
