        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex justify-between items-start">
            <div className="space-y-1">
              ...
              <div className="flex flex-col gap-2 mt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-border-dark font-semibold">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <AppButton customStyles="ml-2 border" icon={Bell} iconClasses="w-5 h-5" />
            </div>
          </div>
        </div>
      </div>
      {isModalOpen?.contact && <ContactForm setIsModalOpen={setIsModalOpen} />}
      {isModalOpen?.contactInfo && <ContactInfo setIsModalOpen={setIsModalOpen} />}
