...
const VideoCard = ({data}) => {
  const {title, id, description,likes, dislikes,src } = data || {};
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center">
          <div className="flex space-x-4">
            <button
              className={`flex items-center space-x-1 ${userAction === 'like'
                  ? 'text-blue-500'
            ...
            <button
              className={`flex items-center space-x-1 ${userAction === 'dislike'
                  ? 'text-red-500'
                  : 'text-gray-500 dark:text-gray-400'
